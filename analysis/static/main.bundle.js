                            ...
                            series: [
                                {
                                    ...
                                    radius: '55%',
                                    center: ['50%', '58%'],
                                    data: majortype.sort(function (a, b) { return a.value - b.value; }),
                                    roseType: 'radius',
                                    itemStyle: {
                                        normal: {
                                            borderWidth: 10,
            ...
            case 2:
                this.vd.getCityJobNumAndSalaryAvg().subscribe(function (data) {
                    if (data['statu'] == __WEBPACK_IMPORTED_MODULE_2__bean_RegisterOrLogin__["b" /* RESULT_OK */].YES) {
                        ...
                        var cityJobNum = [];
                        var xCitys = [];
                        var jobtop = data['data']['chart'].cityjobnumandsalaavg;
                        for (var l = 0; l < jobtop.length; l++) {
...
var SigninComponent = (function () {
    function SigninComponent(bsModalRef, fb, ps, router, cs, modalService) {
        ...
        this.modalService = modalService;
        this.formModel = fb.group({
            username: ["qqq@qq.com", [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__validators_validator__["d" /* usernameValidator */], __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].maxLength(18), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(4)]],
            password: ["111111", [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(6)]],
        });
    }
